...
import { getSearchHistory } from '../../services/standardsApi'
        ...
        <>
          ...
          <div className="panel hidden overflow-x-auto md:block">
            <table data-testid="search-history-table" className="w-full min-w-[640px] text-left text-sm">
              <thead>
                <tr className="border-b border-hairline font-mono text-[10px] uppercase tracking-widest text-slate-500">
                  <th className="px-5 py-3 font-medium">{t('history.timestamp')}</th>
                  <th className="px-5 py-3 font-medium">{t('history.query')}</th>
                  <th className="px-5 py-3 font-medium">{t('history.filters')}</th>
                  <th className="px-5 py-3 text-right font-medium">{t('history.matches')}</th>
