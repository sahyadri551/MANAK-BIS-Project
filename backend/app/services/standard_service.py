...
class StandardService:
    ...
    def get_detail(
        ...
        return StandardDetail(
            ...
            cross_references=(
                standard.cross_references
                or []
            ),

            referenced_by=(
                standard.referenced_by
                or []
            ),
    ...
    def stats(self) -> StatsOverview:
        return StatsOverview(
            ...
            by_status=self.repo.count_grouped(
                Standard.status
            ),

            by_domain=self.repo.count_grouped(
                Standard.domain
            ),
    ...
    def filter_options(
        ...
        return FilterOptions(
            statuses=self.repo.distinct_values(
                Standard.status
            ),
            ...
            domains=self.repo.distinct_values(
                Standard.domain
            ),

            groups=self.repo.distinct_values(
                Standard.group
            ),

            sub_groups=self.repo.distinct_values(
                Standard.sub_group
            ),

            sub_sub_groups=self.repo.distinct_values(
                Standard.sub_sub_group
            ),

            ministries=self.repo.distinct_values(
                Standard.ministry
            ),

            committees=self.repo.distinct_values(
                Standard.committee_name
            ),
        )